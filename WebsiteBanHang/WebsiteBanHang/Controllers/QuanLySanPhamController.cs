...
namespace WebsiteBanHang.Controllers
{
    ...
    public class QuanLySanPhamController : Controller
    {
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult ChinhSua([Bind(Include = "MaSP,TenSP,DonGia,NgayCapNhat,Gioithieu,MoTa,SoLuongTon,LuotXem,LuotBinhChon,LuotBinhLuan,SoLuotMua,Moi,MaNCC,MaNSX,MaLoaiSP,DaXoa")] SanPham sp)
        {
            
            if (ModelState.IsValid)
            {
                SanPham sanPham = db.SanPhams.Find(sp.MaSP);
                TryUpdateModel(sanPham, new string[] { "MaSP", "TenSP", "DonGia", "NgayCapNhat", "Gioithieu", "MoTa",
